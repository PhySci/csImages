...
with col1:
    ...
    prompt = st.text_area(label="prompt", value="Vibrant, cartoon-style cat astronaut, perfect for slot game art.")
    strength = st.slider(label="strength", min_value=0.05, max_value=1.0)
